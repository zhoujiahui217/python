        ...
        try:
            ...
            for i in range(len(value)):
                if len(value) == 1:
                    ...
                    a = a['answer']
                    a = a.replace("\n", "").replace(" ", "")
                    print 'right_answer' + correct_question
                    if a == self.real_answer or correct_question == self.main_question:
...
if __name__ == "__main__":
    ...
    ga = GetAnswer(r'../data/guanwang2.xls', r'../report/test_do_0928.xls')
    ...
    r = Rate()
    r.rate(r'../report/test_do_0928.xls', 'ga.do_score', 'zhengli')
